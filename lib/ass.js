...
function header() {
  return [
    ...
    // Bottom bar. With BorderStyle 3 libass fills the box from OutlineColour and
    // uses BackColour only for the drop shadow, which is the opposite of what the
    // names suggest. The grey used to sit in BackColour, so the box was drawing
    // pure black on a black canvas and there was no bar at all. Outline is the
    // box padding. Verified by cropping the bottom of a real frame.
    'Style: Classic,Poppins,56,&H00FFFFFF,&H00FFFFFF,&H26454545,&H00000000,-1,0,0,0,100,100,0,0,3,14,0,2,70,70,300,1',
